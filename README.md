...
| -------- | ------------- | :------------ | ----------- | ------------- | ----------- | ------------- | ----------- |
| 1        | Bugmaker      | 0.2044        | 0.1049      | 0.2634        | 0.1184      | 0.3491        | 0.1346      |
...
| **Rank** | **Team Name** | **Recall@20** | **NDCG@20** | **Recall@40** | **NDCG@40** | **Recall@80** | **NDCG@80** |
| -------- | ------------- | ------------- | ----------- | ------------- | ----------- | ------------- | ----------- |
| 1        | Bugmaker      | 0.4987        | 0.3245      | 0.5989        | 0.3520      | 0.7022        | 0.3775      |
| 2        | NUDT-WIN      | 0.3911        | 0.2679      | 0.5088        | 0.2985      | 0.6343        | 0.3280      |
