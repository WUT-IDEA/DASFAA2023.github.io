...
| -------- | ------------- | :------------ | ----------- | ------------- | ----------- | ------------- | ----------- |
| 1        | NUDT-WIN      | 0.1904        | 0.1153      | 0.2537        | 0.1292      | 0.3348        | 0.1445      |
| 2        | Reset         | 0.1474        | 0.0868      | 0.1881        | 0.0962      | 0.2465        | 0.1073      |
| 3        | Firework      | 0.1344        | 0.0812      | 0.1899        | 0.0935      | 0.2434        | 0.1035      |
| 4        | SDJTU_1       | 0.0941        | 0.0432      | 0.1224        | 0.0494      | 0.1790        | 0.0603      |

#### MealRec-77

| **Rank** | **Team Name** | **Recall@20** | **NDCG@20** | **Recall@40** | **NDCG@40** | **Recall@80** | **NDCG@80** |
| -------- | ------------- | ------------- | ----------- | ------------- | ----------- | ------------- | ----------- |
| 1        | NUDT-WIN      | 0.3911        | 0.2679      | 0.5088        | 0.2985      | 0.6343        | 0.3280      |
| 2        | Reset         | 0.3654        | 0.2342      | 0.4601        | 0.2604      | 0.5812        | 0.2886      |
| 3        | Firework      | 0.2528        | 0.1574      | 0.3476        | 0.1815      | 0.4518        | 0.2052      |
| 4        | SDJTU_1       | 0.2060        | 0.1285      | 0.2818        | 0.1476      | 0.3778        | 0.1693      |
